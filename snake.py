...
# Os stuf for runing outside IDE
...
"""Amiel u can change the music ^ to be whatever u want like never gunna.
U can also make is so that: (If ingame: play 1 sound else: play another)"""
...
def main():
    ...
    if IN_GAME:
        ...
        # Eating apples
            ...
            float(Tickspeed)
            # Sound
            """is the apple eat audio u can choose ur own"""
            Appleeataudio = mixer.Sound('AppleBite.wav')
            Appleeataudio.set_volume(1.0)
            Appleeataudio.play()
